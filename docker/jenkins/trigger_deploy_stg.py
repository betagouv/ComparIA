...
class JenkinsDeployStgTrigger:
    """Classe pour lancer le déploiement stg sur Jenkins"""
    ...
    def __init__(
        ...
        username: str,
        api_token: str,
        job_name: str = "atnum/stg/languia/deploy-stg",
        timeout: int = 30,
    ):
...
Exemples d'utilisation:
  ...
  python trigger_deploy_stg.py --image-tag abc123def --force-delete --wait
    ...
    parser.add_argument(
        "--job",
        default="atnum/stg/languia/deploy-stg",
        help="Nom du job Jenkins (défaut: atnum/stg/languia/deploy-stg)",
    )
    parser.add_argument(
    ...
    # Création du trigger
    trigger = JenkinsDeployStgTrigger(
