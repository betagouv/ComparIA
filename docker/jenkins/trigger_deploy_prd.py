#!/usr/bin/env python3
"""
Script pour lancer le job de déploiement prd
...
class JenkinsDeployPrdTrigger:
    """Classe pour lancer le déploiement prd sur Jenkins"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Lance le job de déploiement prd sur Jenkins",
...
Exemples d'utilisation:
  ...
  python trigger_deploy_prd.py --image-tag abc123def

  # Avec arguments en ligne de commande
  python trigger_deploy_prd.py --url https://ogehguvsgm-jenkins.services.clever-cloud.com --username admin --token votre_token --image-tag abc123def

  # Avec force delete et attente
  python trigger_deploy_prd.py --image-tag abc123def --force-delete --wait
        """,
    )
    ...
    # Création du trigger
    trigger = JenkinsDeployPrdTrigger(
