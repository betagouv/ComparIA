"""Focused account-erasure service tests."""
...
def test_account_erasure_anonymizes_identity_and_runs_all_cleanup(monkeypatch):
    ...
    # Sessions, consent identifiers/research choice, comparisons, login codes,
    # and invitations each receive a dedicated cleanup statement.
