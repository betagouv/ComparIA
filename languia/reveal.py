...
license_desc = {
    ...
    "propriétaire Alibaba": "Le modèle est accessible via API Alibaba, nécessitant un paiement à l'utilisation basé sur le nombre de tokens traités ou selon les termes de l'entreprise.",
