...
prompts_table = {
    ...
    "langues": [
        ...
        "Quelle est le secret derrière « zorey » et « bonbon » pour éviter les faux pas aux Antilles (et ne pas te retrouver à danser le zouk tout seul) ?",
    ...
    "conseils": [
        ...
        "Quel est le rôle du foufou dans un régime en République démocratique du Congo ?",
        ...
        "Je suis marathonien(ne) et je cherche des conseils sur la meilleure façon d'adapter mon alimentation pendant la saison chaude. Quels sont les aliments les plus hydratants et nutritifs ?",
