...
def rename_llm(old_name: str, new_name: str, *, commit: bool = False):
    ...
    Will update 'model_a_name' and 'model_b_name' columns in all tables
    and specific columns 'model_pair_name', 'chosen_model_name' and
    'refers_to_model'.
    """
