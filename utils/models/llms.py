...
# Raw LLM definitions from LLMS_RAW_DATA_FILE
class LLMDataRawBase(BaseModel):
    """
    Individual LLM raw model definition (before enrichment).

    Raw LLM data loaded from LLMS_RAW_DATA_FILE.
...
# Enriched LLM definition generated from LLMDataRawBase + licenses
class LLMDataRaw(LLMDataRawBase):  # type: ignore
    """
    ...
    Generated by `build_models.py` from LLMS_RAW_DATA_FILE and saved as
