        ...
        <div class="fr-modal__body">
          <div class="fr-modal__header">
            <button
              ...
              on:click={() => sendComment(commenting)}>Fermer</button
            >
          </div>
          <div class="fr-modal__content">
            <p id="modal-prefs" class="modal-title">Ajouter des commentaires</p>
            <div>
              <textarea
              ...
              <button
                ...
                on:click={() => sendComment(commenting)}>Envoyer</button
              >
            </div>
          </div>
        </div>
