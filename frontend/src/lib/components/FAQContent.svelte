<div class="fr-tabs">
  <ul class="fr-tabs__list" role="tablist" aria-label="Foire aux questions">
    ...
    <li role="presentation">
      <button
        ...
        role="tab"
        aria-selected="false"
        aria-controls="tabpanel-donnees-panel">Jeu de données</button
      >
    </li>
    <li role="presentation">
      <button
        id="tabpanel-ecologie"
        class="fr-tabs__tab"
        tabindex="-1"
        role="tab"
        aria-selected="false"
  ...
  <div
    id="tabpanel-usage-panel"
    class="fr-tabs__panel fr-tabs__panel--selected"
    role="tabpanel"
    aria-labelledby="tabpanel-usage"
    tabindex="0"
  >
    <div class="fr-accordions-group">
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-usage-1"
        ...
        <div class="fr-collapse" id="accordion-usage-1">
          <p>
            ...
            le plus probable en fonction de la distribution statistique des données d'entraînement. Bien
            qu'ils puissent synthétiser des informations provenant de diverses sources, ils ne conservent
            pas la trace de l'origine de ces informations.
          </p>
          <p>
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-usage-2"
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-usage-3"
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-usage-4"
        ...
        <div class="fr-collapse" id="accordion-usage-4">
          <p>
            ...
            retenir, agissant comme une mémoire à court terme. Plus la fenêtre est petite, plus le modèle
            est susceptible d'oublier des éléments clés de la conversation, conduisant à des réponses
            incohérentes. Les conversations longues ou complexes peuvent rapidement saturer la fenêtre
            de contexte, augmentant le risque d'incohérence.
          </p>
          <p>
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-usage-5"
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-usage-6">
            Quelle est la différence entre poser une question à un modèle d’IA conversationnelle et
            faire une recherche sur Google ?</button
          >
        </h3>
  ...
  <div
    id="tabpanel-modeles-panel"
    class="fr-tabs__panel"
    role="tabpanel"
    aria-labelledby="tabpanel-modeles"
    tabindex="0"
  >
    <div class="fr-accordions-group">
      <section class="fr-accordion">
      ...
      <section class="fr-accordion">
        ...
        <div class="fr-collapse" id="accordion-modeles-4">
          ...
          <p>
            ...
            nombres utilisés pour représenter les paramètres d'un modèle d'IA. Cela permet de <strong
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button
            ...
            >Y a-t-il un lien entre la nationalité de l’entreprise ou du laboratoire à l’origine du
            modèle et sa capacité à parler plusieurs langues ?</button
          >
        </h3>
  ...
  <div
    id="tabpanel-donnees-panel"
    class="fr-tabs__panel"
    role="tabpanel"
    aria-labelledby="tabpanel-donnees"
    tabindex="0"
  >
    <div class="fr-accordions-group">
      <section class="fr-accordion">
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button
            ...
            >Quelle est la spécificité de compar:IA par rapport à d’autres initiatives similaires ?</button
          >
        </h3>
  ...
  <div
    id="tabpanel-ecologie-panel"
    class="fr-tabs__panel"
    role="tabpanel"
    aria-labelledby="tabpanel-ecologie"
    tabindex="0"
  >
    <div class="fr-accordions-group">
      <section class="fr-accordion">
      ...
      <section class="fr-accordion">
        <h3 class="fr-accordion__title">
          <button
            ...
            >Les indicateurs écologiques tiennent-ils compte du mix énergétique des différents pays
            ?</button
          >
        </h3>
