...
<main id="content" class="">
        ...
        {#each utilyCards as card, i (i)}
          <div class="cg-border">
            <img
              src={card.src}
              alt={card.alt}
              class="fr-responsive-img rounded-t-xl bg-light-grey sm:max-h-2/3 md:max-h-1/3 lg:max-h-1/2 xl:max-h-3/5 h-full! max-h-3/5 object-contain dark:hidden"
            />
            <img
              src={card.srcDark}
              alt={card.alt}
              class="fr-responsive-img rounded-t-xl bg-light-grey sm:max-h-2/3 md:max-h-1/3 lg:max-h-1/2 xl:max-h-3/5 hidden h-full! max-h-3/5 object-contain dark:block"
            />
  ...
  <section
    id="european"
    class="fr-container--fluid bg-light-info pt-10 pb-18 lg:pt-20 lg:pb-25 hidden"
  >
    <div class="fr-container gap-8 lg:flex-row lg:items-center flex max-w-[1150px]! flex-col">
      ...
      <div
        class="gap-8 rounded-xl bg-white px-9 py-15 xl:flex-row flex w-full flex-col justify-center"
      >
        <img
        ...
        <div class="gap-4 sm:grid-cols-2 xl:gap-8 grid">
          {#each europeCards as card, i (i)}
            <div class="cg-border gap-4 bg-very-light-grey px-4 py-5 flex items-center">
  ...
  <section class="fr-container--fluid bg-very-light-grey py-10 lg:py-14">
    <div class="fr-container">
      <div class="cg-border bg-white px-4 py-10 xl:p-13!">
        ...
        <div class="mt-10 md:mt-13 lg:flex-row flex flex-col text-center">
          {#each whyVoteCards as card, index (index)}
            ...
            {#if index < 2}
              <div class="arrow my-5 xl:-ms-12 xl:-me-12 relative shrink-0"></div>
            {/if}
          {/each}
        </div>

        <div class="mt-12 lg:mt-19 flex justify-center">
          <Link
            button
            hideExternalIcon
            size="lg"
