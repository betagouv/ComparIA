  ...
  <div class="fr-container fr-mb-8w">
        ...
        <div class="cadre">
          ...
          <!-- <div class="texte">
                        <p>Impossible de donner une liste objective et définitive des 10 films qui ont le plus influencé
                            ...
                            et
                            des critères d'évaluation. Cependant, voici une liste de 10 films qui sont généralement
                            considérés comme ayant eu un impact significatif sur l'évolution du cinéma :</p>
                        <ol>
                            <li>
                                "La Naissance d'une Nation" (1915) de D.W. Griffith - Bien que controversé pour son
                                contenu
                                raciste, ce film a été une étape importante dans le développement de la narration
                                cinématographique et de la technique cinématographique.
                            </li>
                            <li>
                                "Citizen Kane" (1941) d'Orson Welles - Souvent considéré comme l'un des meilleurs films
                                de
                                tous les temps, il a influencé la narration non linéaire et l'utilisation de l'ombre et
                                de
                                la lumière.
                            </li>
                            <li>"2001 : l'Odyssée de l'espace" (1968) de Stanley Kubrick - Ce film de science-fiction a
                                repoussé les limites de la narration visuelle et a influencé de nombreux autres films du
                                genre.</li>
                            <li>"Le Parrain" (1972) de Francis Ford Coppola - Ce film a révolutionné le genre du film de
                                gangsters et a influencé la façon dont les histoires de crime sont racontées à l'écran.
                            </li>
                            <li>"Jaws" (1975) de Steven Spielberg - Ce film a lancé l'ère des blockbusters et a changé
                                la
                                façon dont les films sont réalisés, commercialisés et distribués.
                            </li>
                            <li>"Star Wars" (1977) de George Lucas - Ce film de science-fiction a lancé une franchise
                                emblématique et a influencé de nombreux autres films de science-fiction et de fantasy.
                            </li>
                            <li>
                                "Taxi Driver" (1976) de Martin Scorsese - Ce film a influencé la façon dont les
                                histoires de
                                personnages complexes et perturbés sont racontées à l'écran.
                            </li>
                            <li>"Pulp Fiction" (1994) de Quentin Tarantino - Ce film a influencé la narration non
                                linéaire
                                et l'utilisation de dialogues stylisés.
                            </li>
                            <li>"Le Silence des Agneaux" (1991) de Jonathan Demme - Ce film a influencé la façon dont
                                les
                                histoires de crime et de thriller sont racontées à l'écran.
                            </li>
                            <li>"Inception" (2010) de Christopher Nolan - Ce film a influencé la façon dont les
                                histoires
                                complexes et les concepts scientifiques sont racontés à l'écran.
                            </li>
                            </ul>
                            <p>Il est important de noter que cette liste n'est pas exhaustive et qu'il existe de
                                nombreux
    ...
    <div>
      ...
      <p>
        ...
        >
        permettent de constituer ces jeux de données de préférence mais peu d’utilisateurs s’en
        servent en français (moins de 1%).
        <strong
