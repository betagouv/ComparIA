<main id="contenu" class="fr-my-7w fr-mt-md-12w fr-mb-md-10w">
  <div class="fr-container">
    ...
    <p>
      Le code source de la plateforme est libre et disponible ici : <a
        href="https://github.com/betagouv/languia">https://github.com/betagouv/languia</a
      >
    </p>
    ...
    <table class="fr-table fr-table__wrapper fr-table__container fr-table__content">
      ...
      <tbody>
        <table>
          ...
          <tbody>
            {#each models as model (model.simple_name)}
              <tr>
    ...
    <p>
      Pour toute question sur le service, vous pouvez écrire à <a
        href="mailto:contact@comparia.beta.gouv.fr">contact@comparia.beta.gouv.fr</a
      >.
    </p>
  </div>
</main>
